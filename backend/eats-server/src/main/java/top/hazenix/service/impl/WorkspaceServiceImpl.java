...
import top.hazenix.vo.BusinessDataVO;
import top.hazenix.vo.DishOverViewVO;
import top.hazenix.vo.OrderOverViewVO;
import top.hazenix.vo.SetmealOverViewVO;
...
public class WorkspaceServiceImpl implements WorkspaceService {
    ...
    public BusinessDataVO getBusinessData(LocalDateTime begin, LocalDateTime end) {
        ...
        //新增用户数
        Integer newUsers = userMapper.sumByDateTime(begin,end);
