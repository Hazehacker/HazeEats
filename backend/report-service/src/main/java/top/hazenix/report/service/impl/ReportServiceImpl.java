package top.hazenix.report.service.impl;
...
import top.hazenix.api.domain.entity.Orders;
import top.hazenix.api.domain.dto.GoodsSalesDTO;
import top.hazenix.api.domain.vo.BusinessDataVO;
...
import top.hazenix.report.service.ReportService;
import top.hazenix.report.service.WorkspaceService;
...
public class ReportServiceImpl implements ReportService {
    ...
    public TurnoverReportVO getTurnoverStatistics(LocalDate begin, LocalDate end) {
        ...
        for (LocalDate date : dateList) {
            ...
            Double turnover = orderClient.sumByStatusAndOrderTime(Orders.COMPLETED,beginTime,endTime);
    ...
    public UserReportVO getUserStatistics(LocalDate begin, LocalDate end) {
        ...
        Integer initialNum = userClient.sumByDateTime(null,firstDateTime);//[同一个mapper方法的复用]
        ...
        for (LocalDate date : dateList) {
            ...
            try {
                dailyNum = userClient.sumByDateTime(beginTime,endTime);
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public OrderReportVO getOrdersStatistics(LocalDate begin, LocalDate end) {
        ...
        for (LocalDate date : dateList) {
            ...
            try {
                dailyCount = orderClient.getCountByDateAndStatus(beginTime,endTime,null);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            //获取每日有效订单数
            Integer dailyValidCount = orderClient.getCountByDateAndStatus(beginTime,endTime,Orders.COMPLETED);
    ...
    public SalesTop10ReportVO getSalesTop10Statistics(LocalDate begin, LocalDate end) {
        ...
        List<GoodsSalesDTO> list = orderClient.getSalesTop10(beginTime,endTime);
