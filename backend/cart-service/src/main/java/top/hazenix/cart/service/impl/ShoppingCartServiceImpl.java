package top.hazenix.cart.service.impl;
...
import top.hazenix.api.domain.entity.Dish;
import top.hazenix.api.domain.entity.Setmeal;
...
import top.hazenix.cart.mapper.ShoppingCartMapper;
...
public class ShoppingCartServiceImpl implements ShoppingCartService
{
    ...
    public void addShoppingCart(ShoppingCartDTO shoppingCartDTO) {
        ...
        if(dishId != null){
            //说明此时要添加的是菜品
            DishVO dish = dishClient.getById(dishId).getData();
            ...
            SetmealVO setmeal = dishClient.getBSetmealById(setmealId).getData();
