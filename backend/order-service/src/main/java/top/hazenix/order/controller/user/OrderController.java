package top.hazenix.order.controller.user;
...
import top.hazenix.order.domain.dto.OrdersPaymentDTO;
import top.hazenix.order.domain.dto.OrdersSubmitDTO;
...
public class OrderController {
    ...
    public void payment(String outTradeNo) throws Exception {
